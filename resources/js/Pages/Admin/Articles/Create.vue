    ...
    <div class="flex min-h-screen bg-gray-50">
        ...
        <div class="flex-1 flex flex-col">
            ...
            <main class="flex-1 p-6">
                <h2 class="text-2xl font-semibold text-gray-900 mb-6">Tambah Artikel</h2>
                ...
                <form @submit.prevent="submit" class="space-y-6 bg-white p-6 shadow rounded-lg">
                    ...
                    <div>
                        ...
                        <div v-if="form.errors.category_id" class="text-red-600 text-sm mt-1">{{ form.errors.category_id
                            }}</div>
                    </div>
